      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl font-bold mb-6">
            <span className="text-green-500">프론티어 기업</span>의 성공 사례
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          >
            <div className="p-8">
              ...
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-medium">김한</h3>
              </div>
          ...
          >
            <div className="p-8">
              <div className="bg-orange-100/50 p-4 rounded-lg text-base text-orange-800 mb-6">
                디지털 마케팅 에이전시 B사는 RomiⒻ의 'Agent Boss' 시스템을 활용해 고객 데이터 분석과 캠페인 최적화에
              ...
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-medium">김보미</h3>
              </div>
